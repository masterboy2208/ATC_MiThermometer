...
static const u8 my_FirmStr[] = {"github.com/masterboy2208"}; // Masterboy github.com/pvvx --> github.com/masterboy2208
...
static const u8 my_ModelStr[] = {"ZBEACON-TH01"};
static const u8 my_HardStr[4] = {"V1.1"};
#if !USE_FLASH_SERIAL_UID
static const u8 my_SerialStr[] = {"0000-0000-0000-0015"}; // "0000-0000-0000-00000"
#endif
static const u8 my_SoftStr[] = {'V','0'+(VERSION>>4),'.','0'+(VERSION&0x0f)}; // "0109"
static const u8 my_ManStr[] = {"Tuya"};

#elif DEVICE_TYPE == DEVICE_ZB_MC

static const u8 my_ModelStr[] = {"ZBEACON-MC"};
static const u8 my_HardStr[4] = {"V1.1"};
#if !USE_FLASH_SERIAL_UID
static const u8 my_SerialStr[] = {"0000-0000-0000-0015"}; // "0000-0000-0000-00000"
#endif
...
static const u8 my_ModelStr[] = {"ZG-303Z"};
static const u8 my_HardStr[4] = {"V1.0"};
#if !USE_FLASH_SERIAL_UID
static const u8 my_SerialStr[] = {"0000-0000-0000-0014"};
#endif
static const u8 my_SoftStr[] = {'V','0'+(VERSION>>4),'.','0'+(VERSION&0x0f)}; // "0109"
...
static const u8 my_ModelStr[] = {"ZBEACON2TH01"};
static const u8 my_HardStr[4] = {"V2.0"};
#if !USE_FLASH_SERIAL_UID
static const u8 my_SerialStr[] = {"0000-0000-0000-002e"}; // "0000-0000-0000-00000"
#endif
static const u8 my_SoftStr[] = {'V','0'+(VERSION>>4),'.','0'+(VERSION&0x0f)}; // "0109"
static const u8 my_ManStr[] = {"Sonoff"};
